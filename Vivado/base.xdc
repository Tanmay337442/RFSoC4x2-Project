...
set_property IOSTANDARD LVCMOS18 [get_ports {pmod0[?]}]
set_property IOSTANDARD LVCMOS18 [get_ports {pmod0[?]}]
set_property PULLTYPE PULLUP [get_ports {pmod0[2]}]
set_property PULLTYPE PULLUP [get_ports {pmod0[3]}]
set_property PULLTYPE PULLUP [get_ports {pmod0[6]}]
set_property PULLTYPE PULLUP [get_ports {pmod0[7]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {pmod1[?]}]
set_property IOSTANDARD LVCMOS18 [get_ports {pmod1[?]}]
set_property PULLTYPE PULLUP [get_ports {pmod1[2]}]
set_property PULLTYPE PULLUP [get_ports {pmod1[3]}]
set_property PULLTYPE PULLUP [get_ports {pmod1[6]}]
set_property PULLTYPE PULLUP [get_ports {pmod1[7]}]

set_property PACKAGE_PIN AW16 [get_ports {trig_in}]
set_property IOSTANDARD LVCMOS18 [get_ports {trig_in}]
set_property PULLTYPE PULLDOWN [get_ports {trig_in}]

set_property PACKAGE_PIN AW15 [get_ports {sync_out}]
set_property IOSTANDARD LVCMOS18 [get_ports {sync_out}]

## SYZYGY Expansion connector - bank 84 and bank 87
set_property PACKAGE_PIN AU2 [get_ports {syzygy_std0_tri_io[0]}]
set_property PACKAGE_PIN A7 [get_ports {syzygy_std0_tri_io[1]}]
set_property PACKAGE_PIN AU1 [get_ports {syzygy_std0_tri_io[2]}]
set_property PACKAGE_PIN A6 [get_ports {syzygy_std0_tri_io[3]}]
set_property PACKAGE_PIN AV3 [get_ports {syzygy_std0_tri_io[4]}]
set_property PACKAGE_PIN C8 [get_ports {syzygy_std0_tri_io[5]}]
set_property PACKAGE_PIN AV2 [get_ports {syzygy_std0_tri_io[6]}]
set_property PACKAGE_PIN C7 [get_ports {syzygy_std0_tri_io[7]}]
set_property PACKAGE_PIN AW4 [get_ports {syzygy_std0_tri_io[8]}]
set_property PACKAGE_PIN E9 [get_ports {syzygy_std0_tri_io[9]}]
set_property PACKAGE_PIN AW3 [get_ports {syzygy_std0_tri_io[10]}]
set_property PACKAGE_PIN E8 [get_ports {syzygy_std0_tri_io[11]}]
set_property PACKAGE_PIN AT7 [get_ports {syzygy_std0_tri_io[12]}]
set_property PACKAGE_PIN F6 [get_ports {syzygy_std0_tri_io[13]}]
set_property PACKAGE_PIN AT6 [get_ports {syzygy_std0_tri_io[14]}]
set_property PACKAGE_PIN E6 [get_ports {syzygy_std0_tri_io[15]}]
set_property PACKAGE_PIN B8 [get_ports {syzygy_std0_tri_io[16]}]
set_property PACKAGE_PIN AR6 [get_ports {syzygy_std0_tri_io[17]}]
set_property PACKAGE_PIN D6 [get_ports {syzygy_std0_tri_io[18]}]
set_property PACKAGE_PIN AR7 [get_ports {syzygy_std0_tri_io[19]}]
set_property PACKAGE_PIN C6 [get_ports {syzygy_std0_tri_io[20]}]
set_property PACKAGE_PIN AU7 [get_ports {syzygy_std0_tri_io[21]}]
set_property PACKAGE_PIN B5 [get_ports {syzygy_std0_tri_io[22]}]
set_property PACKAGE_PIN AV7 [get_ports {syzygy_std0_tri_io[23]}]
set_property PACKAGE_PIN A5 [get_ports {syzygy_std0_tri_io[24]}]
set_property PACKAGE_PIN AU8 [get_ports {syzygy_std0_tri_io[25]}]
set_property PACKAGE_PIN C5 [get_ports {syzygy_std0_tri_io[26]}]
set_property PACKAGE_PIN AV8 [get_ports {syzygy_std0_tri_io[27]}]
set_property PACKAGE_PIN AV6 [get_ports {syzygy_std0_tri_io[28]}]
set_property PACKAGE_PIN B10 [get_ports {syzygy_std0_tri_io[29]}]
set_property PACKAGE_PIN AV5 [get_ports {syzygy_std0_tri_io[30]}]
set_property PACKAGE_PIN B9 [get_ports {syzygy_std0_tri_io[31]}]
...
set_clock_groups -asynchronous -group [get_clocks clk_out1_pgentest_clk_wiz_0_1_1] -group [get_clocks clk_pl_0]
set_clock_groups -asynchronous -group [get_clocks clk_out1_txbackup_clk_wiz_0_1_1] -group [get_clocks clk_pl_0]
set_clock_groups -asynchronous -group [get_clocks clk_out1_reset_clk_wiz_1_0_1] -group [get_clocks clk_pl_0]
