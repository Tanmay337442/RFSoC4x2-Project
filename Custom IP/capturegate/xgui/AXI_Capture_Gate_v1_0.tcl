...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CAPTURE_FIFO_DEPTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.CAPTURE_FIFO_DEPTH { PARAM_VALUE.CAPTURE_FIFO_DEPTH } {
	# Procedure called to update CAPTURE_FIFO_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CAPTURE_FIFO_DEPTH { PARAM_VALUE.CAPTURE_FIFO_DEPTH } {
	# Procedure called to validate CAPTURE_FIFO_DEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.CAPTURE_FIFO_DEPTH { MODELPARAM_VALUE.CAPTURE_FIFO_DEPTH PARAM_VALUE.CAPTURE_FIFO_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CAPTURE_FIFO_DEPTH}] ${MODELPARAM_VALUE.CAPTURE_FIFO_DEPTH}
}
